...
<head>
  ...
  <link href="css/helix_navbar.css" rel="stylesheet">
...
<body>
  <?php require_once( "views/navbar.php"); ?>
    <section>
      <div class="container">
        <div class="row mainHeading-row">
          <div class="col-md-12 mainHeading-col">
            <h1>Internship at helix tech</h1>
            <p>Are you (almost) a fresh BE/BS/BTech CS grad? Take a dive into the deep end by spending a week at Zomato, 
            working with our engineering and product teams on real, live projects that are a part of our development 
            pipeline. Go ahead and apply, because once you've been picked, we take care of everything - your travel to 
            and from our headquarters in Gurgaon, your stay here, and food (obviously).</p> 
          </div>
        </div>
        <div class="headBottomLine"></div>
        <div class="row ">
          <div class="col-md-12 feedBack-col">
            <h2>A Word from Our Previous Rockstars</h2>
            <div class="col-md-6 feedBack">
              <img src="img/students_img1.png">
              <h2>Name 1</h2>
              <h3>College Name</h3>
              <p>Are you (almost) a fresh BE/BS/BTech CS grad? Take a dive into the 
              deep end by spending a week at Zomato, working with 
              our engineering and product teams on real</p>
            </div>
            <div class="col-md-6 feedBack">
              <img src="img/students_img2.png">
              <h2>Name 2</h2>
              <h3>College Name</h3>
              <p>Are you (almost) a fresh BE/BS/BTech CS grad? Take a dive into the 
              deep end by spending a week at Zomato, working with 
  ...
  $(document).ready(function() {
    $('#mobile-click').click(function() {
      $("#mobile-click").hide();
      $("#mobile-nav-modal-backdrop").show();
      $("#mobile-nav-modal-wrap").show();
      $('html, body').css("overflow-y", "hidden");
    });

    $('#close-mobile-nav').click(function() {
      $("#mobile-click").show();
      $("#mobile-nav-modal-backdrop").hide();
      $("#mobile-nav-modal-wrap").hide();
